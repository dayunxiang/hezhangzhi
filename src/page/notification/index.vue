      ...
      <Modal
        ...
        <Form ref="form" :model="form" :rules="rules">
          ...
          <FormItem label="内容" prop="desc">
            <Input v-model="form.desc" type="textarea" :autosize="{minRows: 2,maxRows: 8}"
                   placeholder="编辑公告内容..."></Input>
          </FormItem>
          <FormItem>
