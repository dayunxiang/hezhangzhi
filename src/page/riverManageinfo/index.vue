<template>
  <div class="main">
    <div id="content">
      ...
      <Row>
        <Col>
          <Table ref="table1" id="tb1" border :columns="column1" :data="tableData1" @on-expand="tbexpand"
    ...
    <Modal v-model="showmodname1flag" :styles="{top: atuomodeltop}">
      ...
      <Form ref="formCustom" :model="formCustom" :rules="ruleCustom" :label-width="80">
        ...
        <FormItem label="街道" prop="streetID" v-show="formCustom.type!=1">
          ...
          <Select v-model="formCustom.streetID" style="width:200px" placeholder="请选择街道" filterable
                  @on-change="modstreetchange">
            <Option v-for="item in streetList" :value="item.id" :key="item.id">{{ item.streetName }}
            </Option>
          </Select>
        </FormItem>
    ...
    <Modal v-model="showaddriverflag" :styles="{top: atuomodeltop}">
      ...
      <Form ref="formCustom2" :model="formCustom2" :rules="ruleCustom2" :label-width="80" inline>
        ...
        <FormItem label="街道" prop="streetID">
          ...
          <Select v-model="formCustom2.streetID" style="width:200px" placeholder="请选择街道" filterable
                  @on-change="getcommunityList">
            <Option v-for="item in streetList" :value="item.id" :key="item.id">{{ item.streetName }}
            </Option>
          </Select>
        </FormItem>
